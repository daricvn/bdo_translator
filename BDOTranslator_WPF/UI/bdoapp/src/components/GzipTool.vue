          ...
          <div class="column">
              <div class="col">
                  <span class="text-caption">
                      Please select a source file, and set destination file to begin create bloc file. <br/>
                      This tool allow you to create .bloc file that can be used for BDO Patcher
                  </span>
              </div>
              <!-- Source  -->
              <div class="col">
...
@Component
export default class GzipTool extends Vue {
    open: boolean = false;
    source: string ='';
    destination: string ='';
    ...
    browseDest(){
        this.$q.loading.show();
        this.appService.saveFileDialog("BLOC files|*.bloc").then(res=>{
            if (res.data && res.data.Data)
    ...
    submit(){
        this.$q.loading.show();
        this.appService.gzip(this.source,this.destination).then(res=>{
            this.$q.dialog({
                title:"BLOC file has been created!",
